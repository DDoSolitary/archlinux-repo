...
deps=(
	...
	[libselinux]="libsepol"
	[blueproximity]="bluez-utils-compat pygtk python2-configobj"
	...
	[lib32-ffmpeg]="lib32-aom lib32-dav1d lib32-gsm lib32-lame lib32-libass lib32-libbluray lib32-libomxil-bellagio lib32-opencore-amr lib32-openjpeg2 lib32-vmaf lib32-x265 lib32-xvidcore lib32-x264"
